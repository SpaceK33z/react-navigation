...
}}]);return CardStack;}(_react.Component);CardStack.Card=_Card2.default;CardStack.Header=_Header2.default;CardStack.propTypes={cardStyle:_react.PropTypes.any,headerMode:_react.PropTypes.oneOf(['float','screen','none']),headerComponent:_react.PropTypes.func,mode:_react.PropTypes.oneOf(['card','modal']),gestureResponseDistance:_react.PropTypes.number,transitionConfig:_react.PropTypes.func,gesturesEnabled:_react.PropTypes.bool,navigation:_react.PropTypes.shape({state:_PropTypes2.default.navigationState.isRequired,dispatch:_react.PropTypes.func.isRequired}).isRequired,style:_reactNative.View.propTypes.style};CardStack.defaultProps={mode:'card',gesturesEnabled:_reactNative.Platform.OS==='ios',headerComponent:_Header2.default};
